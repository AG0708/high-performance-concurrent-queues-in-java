...
/** Tail helping must retain both concurrent appends in a valid FIFO order. */
@JCStressTest
...
@Outcome(expect = Expect.FORBIDDEN, desc = "Lost, duplicated, or unreachable node.")
@State
public class MichaelScottTwoProducerTest {
    private final MichaelScottQueue<Integer> queue = new MichaelScottQueue<>();
